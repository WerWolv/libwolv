...
namespace wolv::net {
    ...
    SocketServer::SocketServer(size_t bufferSize, i32 maxClientCount) : m_bufferSize(bufferSize), m_maxClientCount(maxClientCount), m_threadPool(maxClientCount) {
        initializeSockets();
    }
    ...
    void SocketServer::listen(u16 port, const Callback &callback) {
